...
.. table:: Epoch I: The Primordial Void (Core Kernel Foundation)
   ...
   +---------------+----------------------------------+------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
   | Day 88 [DONE] | Area 1 Genesis & Process         | Structural corruption in core kernel files and | Surgically cleaned `process.c`, `syscall.c`, and          |
   |               | Restoration Closure              | hardcoded PID assumptions prevented clean build| `genesis.c`, restored process registry and genesis bridge,|
   |               |                                  | and Law2+Fate matrix verification.             | and dynamicized PID detection for matrix pass.            |
   +---------------+----------------------------------+------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
